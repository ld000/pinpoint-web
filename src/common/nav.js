        ...
        children: [
          {
            name: '应用表格',
            path: 'table-list',
            component: dynamicWrapper(app, ['applicationList'], () => import('../routes/ApplicationInfo/ApplicationList')),
          },
          {
            name: '图',
            path: 'chart',
            component: dynamicWrapper(app, ['applicationList'], () => import('../routes/ApplicationInfo/ApplicationChart')),
          },
        ],
      },
      {
