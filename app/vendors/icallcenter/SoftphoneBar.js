...
//    sip_stDialTalking: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable", "ConsultEnable", "InvestigateEnable"],
...
//    sip_stTalking: ["DialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable", "ConsultEnable", "InvestigateEnable"],
    ...
    dialout: function (phoneNum, custPhoneNum) {
        if (/^\d+$/.test(phoneNum)) {
            this._phone.dialout(phoneNum, custPhoneNum);
            return true;
        } else {
